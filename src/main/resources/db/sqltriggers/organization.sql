...
DROP TRIGGER IF EXISTS organization_custom_id;

//

CREATE TRIGGER organization_custom_id
...
BEGIN
	...
	SET @newCustomIdSeq:= (select waaw_custom_id from organization WHERE waaw_custom_id is not null order by created_date desc limit 1);
